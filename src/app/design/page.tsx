...
function Gallery() {
  ...
  return (
    <div className="mx-auto h-[var(--app-height,100dvh)] max-w-xl overflow-y-auto overscroll-contain px-5 pt-[calc(env(safe-area-inset-top)+24px)] pb-[max(env(safe-area-inset-bottom),6rem)]">
